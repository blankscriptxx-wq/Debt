...
import { SESSION_COOKIE, TENANT_COOKIE, currentSession, query } from '@/lib/console/session';
...
export async function POST(request: Request) {
  ...
  return NextResponse.redirect(new URL('/app/login', request.url), { status: 303 });
}
