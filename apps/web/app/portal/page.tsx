...
import { requireClient, query } from '@/lib/portal/session';
import { loadClientCase } from '@/lib/portal/data';
import { ClientShell } from '@/components/portal/shell';
        ...
        <>
          ...
          {view.outstanding.length > 0 && (
            <div className="cp-card cp-card--action">
              ...
              <Link className="cp-btn cp-btn--primary" href="/portal/documents">
