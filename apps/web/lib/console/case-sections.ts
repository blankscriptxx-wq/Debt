...
export const CASE_SECTIONS: readonly SectionDefinition[] = [
  { slug: 'client', label: 'Identity and details', group: 'The client',
    evidenceKeys: ['identity.verified', 'consent.processing'] },
  { slug: 'living', label: 'Household', group: 'The client',
    evidenceKeys: [], countKey: 'household' },
  { slug: 'verification', label: 'Vulnerability and checks', group: 'The client',
  ...
  { slug: 'finances', label: 'Income and spending', group: 'The money',
    evidenceKeys: ['sfs.complete'] },
  { slug: 'debts', label: 'Debts', group: 'The money',
    evidenceKeys: ['debts.captured'], countKey: 'debts' },
  { slug: 'assets', label: 'Assets', group: 'The money',
    evidenceKeys: [], countKey: 'assets' },

  { slug: 'advice', label: 'Recommendation', group: 'The advice',
    evidenceKeys: [] },
  { slug: 'checklist', label: 'Readiness', group: 'The advice',
  ...
  { slug: 'messenger', label: 'Messages', group: 'The contact',
