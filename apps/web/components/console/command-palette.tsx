...
const COMMANDS: Result[] = [
  { id: 'cmd-cases', label: 'Go to cases', hint: 'Command', href: '/app/cases' },
  { id: 'cmd-tasks', label: 'Go to tasks', hint: 'Command', href: '/app/tasks' },
  { id: 'cmd-approvals', label: 'Go to approvals', hint: 'Command', href: '/app/approvals' },
  { id: 'cmd-compliance', label: 'Go to compliance', hint: 'Command', href: '/app/compliance' },
  { id: 'cmd-analytics', label: 'Go to analytics', hint: 'Command', href: '/app/analytics' },
  { id: 'cmd-workflows', label: 'Go to workflows', hint: 'Command', href: '/app/workflows' },
];
