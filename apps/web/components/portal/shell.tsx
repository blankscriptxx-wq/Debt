  ...
  return (
    <div className="cp-shell">
      <header className="cp-header">
        ...
        <form method="post" action="/portal/sign-out">
      ...
      <nav className="cp-nav" aria-label="Sections">
        <Link href="/portal" aria-current={current === 'progress' ? 'page' : undefined}>Progress</Link>
        <Link href="/portal/messages" aria-current={current === 'messages' ? 'page' : undefined}>Messages</Link>
        <Link href="/portal/documents" aria-current={current === 'documents' ? 'page' : undefined}>Documents</Link>
      </nav>
    </div>
  );
}
