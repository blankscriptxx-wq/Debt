...
export function AppShell({
  ...
  const items = [
    { group: 'Work', links: [
      ...
      { href: '/cases', label: 'Cases', key: 'cases', count: counts.cases },
      { href: '/tasks', label: 'Tasks', key: 'tasks', count: counts.tasks },
      { href: '/approvals', label: 'Approvals', key: 'approvals', count: counts.approvals },
    ]},
    { group: 'Oversight', links: [
      { href: '/compliance', label: 'Compliance', key: 'compliance' },
      { href: '/quality', label: 'Quality assurance', key: 'quality' },
